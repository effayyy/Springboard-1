...
```{r}
# Load data
NH11 <- readRDS("~/Documents/Springboard/Curriculum Projects/MiniProject_LogisticRegression/dataSets/NatHealth2011.rds")
...
```{r}
# Subset the data with only features we are working with
nh11.wrk.age.mar <- subset(NH11, select = c("everwrk", "age_p", "r_maritl"))

# Check that subset was done correctly
summary(nh11.wrk.age.mar)

# Convert everwrk to binary variable
NH11 <- transform(NH11,
                  everwrk = factor(everwrk,
                      levels = c("1 Yes", "2 No")),
                  r_maritl = droplevels(r_maritl))

# Use logistic regression to predict ever worked using age and marital status
...
This tells us that someone who is *Married - spouse in household* has a 10.8% probability of ever having worked.  
Someone who is *Married - spouse not in household* has a 11.3% probability of ever having worked.  
Someone who is *Widowed* has a 19.4% probability of ever having worked.  
Someone who is *Divorced* has a 5.5% probability of ever having worked.  
Someone who is *Separated* has a 9.6% probability of ever having worked.  
Someone who is *Never married* has a 14.6% probability of ever having worked.  
Someone who is *Living with partner* has a 7.2% probability of ever having worked.  
Someone whose marital status is unknown has a 15.3% probability of ever having worked.  